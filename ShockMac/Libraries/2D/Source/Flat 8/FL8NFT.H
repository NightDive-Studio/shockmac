 ...
 * $Revision: 1.5 $
 * $Author: kevin $
 * $Date: 1994/10/25 15:11:28 $
 *
 * Normal fill mode function table.
 * flat8 canvas.
 *
...
/* BMT_FLAT8 */
 ...
 (ptr_type) gr_not_imp, //### MLA- not supposed to be used   (ptr_type) gri_opaque_true_lin_umap_init,   /* Linear mappers */
   gr_null,
   gr_null,
   gr_null,
 (ptr_type) gr_not_imp, //### MLA- not supposed to be used   (ptr_type) gri_opaque_clut_true_lin_umap_init,
   gr_null,
