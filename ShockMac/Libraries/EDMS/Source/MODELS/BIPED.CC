...
//		Tools...
//		========
inline void	globalize( Q &X, Q &Y, Q &Z );
inline void	localize( Q &X, Q &Y, Q &Z );
void		place_right_knee( int ),
			place_left_knee( int );
...
//	For transformations...
//	======================
static Q	Ta, Tb, Tc, Td, Te, Tf, Tg, Th, Ti;
static Q	Ub, Uc, Ud, Uf, Ug, Uh;
...
//	Procmpute these elements for transformations...
//	-----------------------------------------------
	Ta = cos_alpha*cos_gamma;
	Tb = cos_gamma*sin_alpha*sin_beta - cos_beta*sin_gamma;
	Tc = cos_beta*cos_gamma*sin_alpha + sin_beta*sin_gamma;

	Td = cos_alpha*sin_gamma;
	Te = cos_beta*cos_gamma + sin_alpha*sin_beta*sin_gamma;
	Tf = cos_beta*sin_alpha*sin_gamma - cos_gamma*sin_beta;

	Tg = -sin_alpha;
	Th = cos_alpha*sin_beta;
	Ti = cos_alpha*cos_beta;

	Ub = cos_alpha*sin_gamma;
	Uc = -sin_alpha;

	Ud = cos_gamma*sin_alpha*sin_beta - cos_beta*sin_gamma;
	Uf = cos_alpha*sin_beta;

	Ug = cos_beta*cos_gamma*sin_alpha + sin_beta*sin_gamma;
	Uh = cos_beta*sin_alpha*sin_gamma - cos_gamma*sin_beta;
...
Q	otemp	= A[object][0][1]*object4 + A[object][1][1]*object5;
Q	object7 = I[object][22] * otemp;					//Delta_magnitude...
